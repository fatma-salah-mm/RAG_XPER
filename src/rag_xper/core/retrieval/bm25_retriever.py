...
_NUM_TO_WORDS = {
    "1": ["اول", "الاول", "واحد", "حادي"],
    "2": ["ثاني", "الثاني", "اثنين", "اثنان"],
    "3": ["ثالث", "الثالث", "ثلاثه", "ثلاث"],
    "4": ["رابع", "الرابع", "اربعه", "اربع"],
    "5": ["خامس", "الخامس", "خمسه", "خمس"],
    "6": ["سادس", "السادس", "سته", "ست"],
    "7": ["سابع", "السابع", "سبعه", "سبع"],
    "8": ["ثامن", "الثامن", "ثمانيه", "ثمان"],
    "9": ["تاسع", "التاسع", "تسعه", "تسع"],
    "10": ["عاشر", "العاشر", "عشره", "عشر"],
    "20": ["عشرون", "عشرين"],
    "30": ["ثلاثون", "ثلاثين"],
    "40": ["اربعون", "اربعين"],
    "50": ["خمسون", "خمسين"],
...
def stem_arabic_word(word: str) -> str:
    ...
    for suffix in ["هم", "هن", "كم", "كن", "نا", "ها", "ات", "ون", "ين", "ان", "يه", "يا"]:
    ...
    for tok in raw_tokens:
        ...
        if expand_numbers and tok in _NUM_TO_WORDS:
            for w in _NUM_TO_WORDS[tok]:
                tokens.append(w)
                tokens.append(stem_arabic_word(w))
