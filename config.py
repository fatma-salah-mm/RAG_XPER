"""
config.py for RAG_XPER

Centralised configuration for the RAG_XPER pipeline, loaded from environment
variables (via a ``.env`` file) with sensible defaults and fast validation.
"""
...
class Settings:
    ...
    chunking_strategy: str = os.getenv("CHUNKING_STRATEGY", "recursive").lower()  # "recursive" | "parent_child" | "article_based" | "auto"
